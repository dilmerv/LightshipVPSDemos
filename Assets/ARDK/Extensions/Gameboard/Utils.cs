...
namespace Niantic.ARDK.Extensions.Gameboard
{
  public static class Utils
  {
    ...
    internal static void FastFitPlane
    (
      Vector3[] points,
    ...
    /// Converts a world position to a node on the Gameboard.
    ...
    /// Converts a node on the Gameboard to its corresponding world position.
